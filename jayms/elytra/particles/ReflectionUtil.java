...
public final class ReflectionUtil {
	...
	private static final Class<?>[] primitives = new Class<?>[] { String.class, Integer.class, Long.class,
			Character.class, Short.class, Byte.class, Double.class, Float.class };

	public static boolean isPrimitive(Class<?> clazz) {
		return Arrays.asList(primitives).contains(clazz) || clazz.isPrimitive();
	}
